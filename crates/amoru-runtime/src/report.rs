...
use amoru_controller::{Bottleneck, ControllerSummary};
use amoru_kernel::{GilState, IoPaths, Limits, RunId, StageId};
use amoru_scheduler::RunOutcome;
use amoru_trace::{ExitReason, RunMeta, RunReport, TraceView};
...
mod tests {
    use super::*;
    use amoru_controller::ControllerSummary;
    use amoru_kernel::{AmoruError, KnobSnapshot};
    ...
    fn the_timeline_names_every_bottleneck() {
        ...
        let meta = meta(MetaInput {
            run_id: amoru_kernel::RunId([1; 16]),
            ...
            notes: Vec::new(),
            gil: Vec::new(),
            io_paths: amoru_kernel::IoPaths::default(),
    ...
    fn a_run_without_a_controller_still_has_meta() {
        let meta = meta(MetaInput {
            run_id: amoru_kernel::RunId([2; 16]),

...
fn is_exhausted_plan(e: &moruna_kernel::MorunaError) -> bool {
    matches!(e, moruna_kernel::MorunaError::Plan(msg) if msg.contains("nothing to probe with"))
}

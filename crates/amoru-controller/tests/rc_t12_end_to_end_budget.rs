...
#[test]
#[ignore = "integration, closes in wave 4: needs amoru-runtime and a container with --memory"]
fn rc_t12_end_to_end_budget() {
    ...
    panic!(
        "RC-T12 cannot run yet: amoru-runtime (wave 4) and the benchmark kernels of preamble \

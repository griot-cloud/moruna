...
//!
//! It is ignored here because it needs what does not exist yet: `amoru-runtime` (the facade,
...
#[test]
#[ignore = "reference host, E1: needs amoru-runtime, the bench kernels and the wave 5 tuned baselines"]
fn rc_t13_throughput() {
    // Not a silent pass: a throughput claim nobody has measured is worse than no claim.
    panic!(
        "RC-T13 cannot run yet: amoru-runtime (wave 4), the benchmark kernels and the tuned \

...
use amoru_kernel::{DType, Fingerprint, SourceSchema};
...
const GOLDEN: &str = "5838addf74ece078ae646120bc82cad7f53f1b01d2687b3dfa7b9943ab8c91bd";

#[test]
fn ct_t10_fingerprint_stability() {
    let identity = "amoru-bench 0.1.0 ::kernels::Normalise";
    ...
    assert_ne!(
        Fingerprint::compute("amoru-bench 0.1.0 ::kernels::normalise", config),
        first
    );
    assert_ne!(

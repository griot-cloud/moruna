//! `amoru.inspect_host()` (d.2, j): what the runtime would discover on this host, without
//! starting anything.

use amoru_kernel::{Guarantee, Limits};
use amoru_runtime::{DiscoveryInput, Runtime};
use pyo3::prelude::*;

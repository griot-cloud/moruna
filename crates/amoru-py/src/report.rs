...
//! `amoru_trace::RunReport` (04 d.1), `__str__` gives the fixed layout of at most forty lines,
...
use amoru_trace::{ExitReason, RunReport};
use pyo3::prelude::*;
use pyo3::types::{PyDict, PyList, PyModule};

/// The run report as Python sees it.
#[pyclass(frozen, module = "amoru._core", name = "RunReport")]
...
impl PyRunReport {
    ...
    /// The report as JSON, exactly `amoru_trace::RunReport::to_json`.
...
mod tests {
    use super::*;
    use amoru_kernel::{GilState, IoPaths};
    use amoru_trace::{LimitsSummary, StageReport};
    ...
    fn py_t5_report_object() {
        for (stages, notes) in [(0, 0), (3, 2), (60, 40)] {
            ...
            assert!(text.contains("amoru run"));
        }

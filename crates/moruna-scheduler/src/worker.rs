...
pub(crate) fn run_task(
    ...
    let applied = match raw {
        ...
        Err(panic) => Applied::Failed(MorunaError::Kernel {
            stage,
            seq,
...
fn enrich(e: MorunaError, stage: StageId, seq: Seq, features: &MorselFeatures) -> MorunaError {
    match e {
        MorunaError::Kernel { msg, .. } => MorunaError::Kernel {
            stage,
            seq,
            msg,
            features: Some(features.clone()),

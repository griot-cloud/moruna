...
impl FakeReactor {
    ...
    fn io_error(op: &'static str, target: &str) -> MorunaError {
        MorunaError::Io {
            op,
    ...
    // `MorunaError` carries a morsel's features (CT-I10), so it is large beside this helper's

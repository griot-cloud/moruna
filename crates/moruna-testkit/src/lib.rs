//! Moruna test fakes: one fake per contracts trait, exactly the table in contracts d.15.
//!
...
//!
//! The crate depends on `moruna-kernel` only. Its behaviour is deterministic: no fake reads a

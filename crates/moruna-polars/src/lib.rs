//! Moruna engine bridge: hosts a kernel inside Polars (05-adapters f.5, AD-I6).
//!
...
//! [`moruna_kernel::Kernel::apply`] with [`moruna_kernel::NoState`], and returns the first output
...
// Every fallible call into Moruna returns the contract's `MorunaError` (contracts d.14), whose

//! Moruna component 1, the contracts crate: every type and trait that crosses a component boundary.
//!
...
//! the aligned binary format `MRB1` (`mrb1`) and the page-aligned Arrow IPC record (`ipc`).
...
// Re-exporting them here is how a crate that depends on `moruna-kernel` alone, the testkit of

...
use moruna_kernel::{MorunaError, RowRange, Split, SplitId};
...
pub(crate) fn source_err(split: SplitId, msg: impl Into<String>) -> MorunaError {
    MorunaError::Source {
        split,
        msg: msg.into(),
    }
...
mod tests {
    ...
    fn ranges_are_checked_against_the_split() {
        ...
        assert!(matches!(e, MorunaError::Source { split, .. } if split == 3));

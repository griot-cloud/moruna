//! The Moruna aligned binary format (`MRB1`) writer.
//!
...
//!
//! Little endian throughout. This writer does not depend on `moruna-kernel`: the
//! kernel crate's own `mrb1` module is being written in parallel, and a
...
pub struct TensorSpec {
    /// The tensor's name: the file stem for `MRB1`, the key for safetensors.
    pub name: String,
    /// The element type.
    pub dtype: DType,

...
| Q8 | Reference GPU host and reference NVMe host for the direct-path gates (preamble E1) | Brackly | open; assumption: the developer's machine, results provisional, GPU and GDS tests skipped and listed | |

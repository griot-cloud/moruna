...
Hand written, and checked against the module by PY-T5: every public symbol of ``amoru._core``
...
class PlanError(AmoruError): ...
class KernelError(AmoruError): ...
class BudgetError(AmoruError): ...
class IoError(AmoruError): ...
class ConfigError(AmoruError): ...
class ResumeError(AmoruError): ...
class Cancelled(AmoruError): ...
